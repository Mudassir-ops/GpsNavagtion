...
public class TestActivity extends AppCompatActivity implements
    ...
    private void enableLocationComponent(@NonNull Style loadedMapStyle) {
       ...
       /*     LocationComponentOptions customLocationComponentOptions = LocationComponentOptions.builder(this)
                    ...
                    .foregroundDrawable(R.drawable.ic_baseline_play_arrow_24)
                    .build();
*/
            LocationComponentOptions customLocationComponentOptions = LocationComponentOptions.builder(this)
                    .elevation(5)
            ...
            findViewById(R.id.back_to_camera_tracking_mode).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (!isInTrackingMode) {
                        ...
                        Toast.makeText(TestActivity.this, "tracking enabled",
                                Toast.LENGTH_SHORT).show();
                    } else {
                        Toast.makeText(TestActivity.this, "already enabled",
                                Toast.LENGTH_SHORT).show();
                    }
                }
            });
